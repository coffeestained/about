    ...
    <div id="map" class="map">
        <div class="mapType">
            ...
            <div id="interactive-options">
                ...
                <div>
                    <input type="checkbox" name="county-congressional" onchange="addShapeFileLayer('./docs/assets/cb_2021_us_county_within_cd116_500k');"/> 
                    <i class="fa-solid fa-scale-unbalanced"></i> County Congressional Zoning
                </div>

                <div>
                    <input type="checkbox" name="school-zoning" disabled="disabled" onchange="addShapeFileLayer('./docs/assets/cb_2021_us_county_within_cd116_500k');"/> 
